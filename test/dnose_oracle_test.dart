...
void main() {
  ...
  test("Detect: Assertion Roullet", () {
    verify(
        ...
        qtd: 25,
        pathFile: "/test/oracle/assertion_roulette_test.dart");
  });
  ...
  test("Detect: Test Without Description", () {
    verify(
        ...
        qtd: 5,
        pathFile: "/test/oracle/test_without_description_test.dart");
  });

  test("Detect: Empty Test", () {
    verify(
        name: "Empty Test", qtd: 6, pathFile: "/test/oracle/empty_test.dart");
  });
